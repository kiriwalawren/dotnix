{
  flake.modules.nixos.homelab =
    ...
    in
    {
      ...
      systemd.services.qbittorrent-protonvpn-port-forward =
        lib.mkIf (config.nixflix.vpn.enable && qbCfg.vpn.enable)
          {
            ...
            serviceConfig = {
              ...
              ExecStart =
                ...
                in
                pkgs.writeShellScript "qbittorrent-protonvpn-port-forward" ''
                  QB_HOST="${qbHost}"
                  QB_USER="${qbUser}"
